...
-- -----------------------------------------------------
-- Table `student_project`.`grado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS student_project.grado (
    id_grado serial PRIMARY KEY,
    nombre VARCHAR(255) UNIQUE NOT NULL
);

INSERT INTO student_project.grado (nombre) VALUES
...
('Doble Grado en Lenguas Modernas, Literaturas y Culturas y en Educación Primaria'),
...
('Grado en Estudios de Asia Oriental por la Universidad de Sevilla y la Universidad de Málaga'),
...
('Doble Grado en Estadística y Finanzas y Contabilidad'),
...
('Grado en Ciencias Ambientales por la Universidad Pablo de Olavide'),
...
('Grado en Derecho'),
('Grado en Derecho y Laurea Magistrales en Giurisprudenza (USE y Universidad de Florencia)'),
('Grado en Economía'),
...
('Doble Grado en Ingeniería en Diseño Industrial y Desarrollo del Producto e Ingeniería Mecánica'),
